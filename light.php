      ...
      <div>
        ...
        <div id="flex-end">
          ...
          <div style="margin-top: 15px;"><input id="loop" type="image" src="loop_all.png" value="Loop"
              onclick="changeLoop()" width="50" height="50" style="outline: none"><input type="image"
              src="previous.png" value="Previous" onclick="previous()" width="50" height="50"
              ...
              value="100" style="margin-right: 5px;"><img src="volume-up.png" width="25px">
          </div>
        </div>
      </div>
    </div>
